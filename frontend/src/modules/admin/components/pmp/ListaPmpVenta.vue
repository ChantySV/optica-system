<!-- src/components/VentaPmpTable.vue -->

<template>
  <div class="bg-white p-6 rounded-lg shadow overflow-x-auto">
    <h2 class="text-2xl font-semibold text-gray-700 mb-4">Ventas</h2>
    <div v-if="loading" class="text-center text-gray-500">Cargando datos de ventas...</div>
...
import type { PmpVentaData } from '../../interfaces/pmpResponse.interface';
...
const totalPages = computed(() => {
  return Math.ceil(props.totalItems / 10); // Asumiendo itemsPerPageVenta = 10
});
