<!-- src/components/MainPersonalJuridico.vue -->
...
const listaPersonalRef = ref<InstanceType<typeof ListaPersonalJuridico> | null>(null);

// Función para manejar el evento 'created' emitido por el modal
const handleCreated = () => {
  if (listaPersonalRef.value) {
    listaPersonalRef.value.reloadData();
  }
  closeCreateModal();
};
</script>
